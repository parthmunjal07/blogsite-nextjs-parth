...
export default async function AdminDashboardPage() {
  ...
  // Mock post owner ID for demonstration
  const mockPostOwnerId = userId || "mock_owner_id";
          ...
          <table className="w-full text-left border-collapse min-w-[700px]">
            <thead>
              <tr className="border-b border-outline-variant/50">
                ...
                {isCreatorOrAdmin && <th className="font-label-md text-label-md text-on-surface-variant py-3 pl-4 font-normal text-right">Actions</th>}
              </tr>
            </thead>
            <tbody className="font-body-md text-body-md">
              ...
              {/* Additional Mock Rows omitted for brevity... */}
              <tr className="border-b border-outline-variant/30 hover:bg-surface/50 transition-colors group">
